			...
			<table class="table2excel">
				...
				<tbody>
					<!-- <tr v-for="(newItem,newIndex) in newList" :key="newIndex">
						<td v-if="newIndex == 0" :rowspan="newList.length">1</td>
						<td v-if="newIndex == 0" :rowspan="newList.length">2123213</td>
						<td v-if="newIndex == 0" :rowspan="newList.length">2</td>

						<td v-html="newItem.qdname"></td>
						<td v-html="newItem.qdscore"></td>
						<td v-html="newItem.qddescribe">完成</td>

						<td v-html="newItem.hdname">甲</td>
						<td v-html="newItem.hdscore">20%</td>
						<td v-html="newItem.hddescribe">完成</td>

						<td v-html="newItem.sjname">甲</td>
						<td v-html="newItem.sjscore">20%</td>
						<td v-html="newItem.sjdescribe">完成</td>
					</tr> -->
					<tr>
						<td rowspan="5">1</td>
						<td rowspan="5">xxx</td>
	...
	export default {
		...
		methods: {
			...
			findResult (){
					...
					params.append("start_time", this.end_time[0]);
					params.append("end_time", this.end_time[1]);
					
					console.log(this.end_time[0])
					console.log(this.end_time[1])
					this.$axios({
						url: '/getscreenxz',
						method: 'post',
						headers: {
