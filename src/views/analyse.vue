	...
	<div id="scheduling">
		...
		<div class="table" border="1">
			...
			<div class="search-content">
				...
				<el-button class="search" @click.native="addAnalyse">添加案例</el-button>
			...
			<table class="table2excel" id="dataTable">
				<thead>
					<tr>
						<td style="min-width: 100px;max-width: 200px;padding:0 5px;width: 100px;background-color:#fffd38;color:#000;text-align:center;height:100px;line-height:100px;font-weight: bold;">项目名称</td>
						<td style="min-width: 100px;max-width: 200px;padding:0 5px;width: 100px;background-color:#fffd38;color:#000;text-align:center;height:100px;line-height:100px;font-weight: bold;">链接</td>
						<td style="min-width: 100px;max-width: 200px;padding:0 5px;width: 100px;background-color:#fffd38;color:#000;text-align:center;height:100px;line-height:100px;font-weight: bold;">是否上线</td>
						<td style="min-width: 100px;max-width: 200px;padding:0 5px;width: 100px;background-color:#fffd38;color:#000;text-align:center;height:100px;line-height:100px;font-weight: bold;">上线日期</td>
						<td style="min-width: 100px;max-width: 200px;padding:0 5px;width: 100px;background-color:#fffd38;color:#000;text-align:center;height:100px;line-height:100px;font-weight: bold;">交付日期</td>
						<td style="min-width: 100px;max-width: 200px;padding:0 5px;width: 100px;background-color:#fffd38;color:#000;text-align:center;height:100px;line-height:100px;font-weight: bold;">平台</td>
						<td style="min-width: 100px;max-width: 200px;padding:0 5px;width: 100px;background-color:#fffd38;color:#000;text-align:center;height:100px;line-height:100px;font-weight: bold;">商务</td>
						<td style="min-width: 100px;max-width: 200px;padding:0 5px;width: 200px;background-color:#fffd38;color:#000;text-align:center;height:100px;line-height:100px;font-weight: bold;">备注(1:已做了案例分析)</td>
					</tr>
				</thead>
				<tbody>
					<tr v-for="dataItem in dataList" :key="dataItem.id">
						<td style="padding:0 5px;text-align:center;height:100px;line-height:100px;border-botom:1px solid #000;">
<!-- 						{{dataItem.pro_name}} -->
						<input style="max-width: 200px;background:#f5f5f5;border: none;
						padding: 0px 5px;
						overflow: hidden;
						text-overflow: ellipsis;
						white-space: nowrap;" class='btn_copy' type="button" name="anniu2" @click='copyUrl(dataItem.pro_name)' v-model="dataItem.pro_name">
										</td>
						</td>
						<td style="max-width:200px;padding-right:20px;overflow: hidden;text-overflow:ellipsis;white-space: nowrap;width:100px;overflow:hidden;padding:0 5px;text-align:center;height:100px;line-height:100px;border-botom:1px solid #000;"
						 v-if="dataItem.pro_url != ''">
								<input style="max-width: 200px;background:#f5f5f5;border: none;
		padding: 0px 5px;
		overflow: hidden;
		text-overflow: ellipsis;
		white-space: nowrap;" class='btn_copy' type="button" name="anniu2" @click='copyUrl(dataItem.pro_url)' v-model="dataItem.pro_url">
						</td>
						<td style="width:100px;overflow:hidden;padding:0 5px;text-align: center;height:100px;
    " v-else>
							<img width="80px" height="80px" class='pro_img' :src="dataItem.pro_img" />
						</td>
						<td style="padding:0 5px;text-align:center;height:100px;line-height:100px;border-botom:1px solid #000;">{{dataItem.online_type == 1 ? '已上线' : '未上线'}}</td>
						<td style="padding:0 5px;text-align:center;height:100px;line-height:100px;border-botom:1px solid #000;">{{dataItem.online_time}}</td>
						<td style="padding:0 5px;text-align:center;height:100px;line-height:100px;border-botom:1px solid #000;">{{dataItem.deliver_time}}</td>
						<td style="padding:0 5px;text-align:center;height:100px;line-height:100px;border-botom:1px solid #000;">{{dataItem.platform}}</td>
						<td style="padding:0 5px;text-align:center;height:100px;line-height:100px;border-botom:1px solid #000;">{{dataItem.sale_name}}</td>
						<td style="padding:0 5px;text-align:center;height:100px;line-height:100px;border-botom:1px solid #000;">{{dataItem.remarks}}</td>
					</tr>
				</tbody>
				<!-- 				<tfoot>
					<tr>
		...
		<el-dialog :visible.sync="finishModalShow" :append-to-body='true' class='finish_modal'>
			...
			<van-field v-model="result.remarks" rows="3" autosize label="备注(1 表示已做了案例分析)" type="textarea" placeholder="请输入留言"
			 class='remarks' />
			<!-- 			<div class='input_form'>
			...
			<div class='add_submit' @click="addCenter">
			...
			findCenter() {
				this.$axios({
					...
					if (res.data.data) {
						...
						data.forEach((item) => {
							item.online_time = (item.online_time == '' || item.online_time == null) ? '' : item.online_time;
							item.deliver_time = (item.deliver_time == '' || item.deliver_time == null) ? '' : item.deliver_time;
						})
						this.dataList = data;
					}
