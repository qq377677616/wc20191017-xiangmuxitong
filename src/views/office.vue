        ...
        <el-dialog :visible.sync="dialogFormVisible" :append-to-body='true'>
            <el-form ref="form" label-width="80px">
                <el-form-item label="职员姓名">
                    <el-input v-model="personInfo.name" @blur="scrollChange" placeholder="请输入姓名"></el-input>
                </el-form-item>
                <el-form-item label="手机号码">
                    <el-input v-model="personInfo.phone" @blur="scrollChange" placeholder="请输入手机号码" type="tel" maxlength="11"></el-input>
                </el-form-item>
        ...
        methods : {
            ...
            addPerson(){
                ...
                if(this.personInfo.phone == '') {
                    this.$toast({message:'电话不能为空！',duration:1000});
                    return;
                }
                let Index = ''
